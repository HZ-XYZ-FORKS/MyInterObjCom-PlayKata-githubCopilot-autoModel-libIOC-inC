...
Commands should follow their group contract so Copilot, Cline, Continue, `utCodeAgentCLI`, and similar assistants can consume the same portable command intent.
