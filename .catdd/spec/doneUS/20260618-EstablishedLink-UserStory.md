...
> **Story ID:** US-1 | **State:** done-closed | **Priority:** P1
...
| CodeAgent intent | Keep execution constrained to US-1, preserve current acceptance/boundary decisions, and route planning through `SPEC_makePlan` before design or implementation. |
