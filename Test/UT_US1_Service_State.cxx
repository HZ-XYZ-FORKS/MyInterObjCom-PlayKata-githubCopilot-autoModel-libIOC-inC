...
///////////////////////////////////////////////////////////////////////////////////////////////////
// UT_US1_Service_State.cxx - CaTDD Implementation for IOC Link Establishment
// (State)
//
// PURPOSE:
...
/**
 * @brief
 *   [WHAT] This file verifies IOC service lifecycle and state-related
 * behaviors. [WHERE] in the IOC Service API module. [WHY] to ensure state-query
 * determinism and queue-resolution consistency across transitions.
 *
 * SCOPE:
 ...
 *   - Out of scope: capacity-limit pressure and nominal happy-path
 * establishment.
 *
 * RELATIONSHIPS:
 *   - Related tests: UT_US1_Service_Typical.cxx, UT_US1_Service_Edge.cxx,
 *     UT_US1_Service_Misuse.cxx, UT_US1_Service_Fault.cxx,
 ...
 * AC-3: Service lifecycle transitions preserve deterministic state/availability
 * semantics.
 */
...
TEST_F(
  ...
  //===>>> SETUP <<<===
  UT_PHASE_SETUP("TC_P1_S1_verifyServiceState_byOfflineToOnlineToOffline_"
...
TEST_F(
  ...
  //===>>> SETUP <<<===
  UT_PHASE_SETUP("TC_P1_S2_verifyPendingQueue_byAcceptTimeoutOffline_"
  ...
  IOC_Result_T acceptResult =
      IOC_acceptClient(offlineSrvID, &acceptedLinkID, nullptr);

  //===>>> VERIFY <<<===
  UT_PHASE_VERIFY(
      "pending connect resolves once as failure and later accept is rejected");
  VERIFY_KEYPOINT_NE(
