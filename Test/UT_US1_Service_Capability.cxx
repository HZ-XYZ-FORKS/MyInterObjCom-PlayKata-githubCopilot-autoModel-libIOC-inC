...
///////////////////////////////////////////////////////////////////////////////////////////////////
// UT_US1_Service_Capability.cxx - CaTDD Implementation for IOC Link
// Establishment (Capability)
//
// PURPOSE:
//   Test-driven implementation of P1 Design / Capability category for US-1:
//   capability boundary behaviors around usage compatibility and auto-accept
//   constraints.
//
// TDD WORKFLOW:
...
TEST_F(
  ...
  //===>>> SETUP <<<===
  UT_PHASE_SETUP("TC_P1_C1_verifyCapabilityBoundary_byComplementaryUsage_"
  ...
  IOC_Result_T allowedResult =
      IOC_connectService(&allowedLinkID, &connArgs, nullptr);
...
TEST_F(
  ...
  //===>>> SETUP <<<===
  UT_PHASE_SETUP("TC_P1_C2_verifyCapabilityBoundary_byManualAcceptInAutoMode_"
